...
Generated: 2026-08-02T18:01:44.010292+00:00
Run directory: `C:\Users\mraja\CursorApps\green-bin-app\backend\benchmark-results\cloudflare-text-models\smoke-gpt-oss-analyzer-max900`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| gpt_oss_20b | plain | 1 | 0.000 | 1.000 | 0.000 | 0.000 | 0.000 | 4318.3 | 4318.3 | 4318.3 | 0.000 | 36.6 |

## Results By Case

| case_id | use_case | model_label | mode | run_index | complete | schema_valid | hallucination | failure_reason | latency_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| analyzer_seattle_mouse_split | evidence_analysis | gpt_oss_20b | plain | 1 | False | True | False |  | 4318.3 |

## Important Successes And Failures

- `gpt_oss_20b` `plain` `analyzer_seattle_mouse_split` run 1: failure=None validation={'schema_valid': True, 'action_correct': True, 'destination_correct': True, 'evidence_exact': False, 'citation_correct': True, 'combined_evidence': False, 'unsupported_claims': False, 'hallucination': False, 'complete': False, 'manual_review': False, 'errors': [], 'validation_issues': [], 'removed': [], 'status_correct': True, 'excluded_route_correct': True}
